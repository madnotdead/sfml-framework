...
namespace Game
{
	...
	void Level01State::Init()
	{
		...
		mEnemyGenerator->addEnemy(*image, false, Game::MOVE_Z, 2.0f);
		image = imageManager.getResource("resources/enemies/egg.png");
		mEnemyGenerator->addEnemy(*image, false, Game::MOVE_L, 2.0f);
		image = imageManager.getResource("resources/enemies/chupetin.png");
		mEnemyGenerator->addEnemy(*image, false, Game::LINEAR, 2.0f);
		image = imageManager.getResource("resources/enemies/ball.png");
		mEnemyGenerator->addEnemy(*image, false, Game::BOUNCE, 2.0f);
		image = imageManager.getResource("resources/enemies/bee.png");
		mEnemyGenerator->addEnemy(*image, false, Game::SIN, 2.0f);
		...
		mEnemyGenerator->addEnemy(*image, false, Game::DIAGONAL, 2.0f);
